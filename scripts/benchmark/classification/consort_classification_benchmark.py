...
TRUE_JSON_PATH = DATASET_DIR / "classification" / "consort_classification.json"
PRED_JSON_PATH = DATASET_DIR / "classification" / "template_example_results.json"


def main(argv: Sequence[str] | None = None) -> None:
    parser = ArgumentParser(description="Benchmark CONSORT image classifications.")
    parser.add_argument(
        "--true-path",
        type=Path,
