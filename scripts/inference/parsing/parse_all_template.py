...
DIR_NAME_TO_SAVE_RESULTS = "template_parse_all_results"
...
I want you to parse the nodes, flow, labels and any additional text.
...
- Nodes should only point to nodes that exist in the diagram.
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = ArgumentParser(description="Parse all flowchart parts.")
    parser.add_argument(
        "--model",
        default=MODEL,
