...
DIR_NAME_TO_SAVE_RESULTS = "template_parse_just_labels_results"
...
INPUT_TEXT = """
I am sending you an image of a particpant flow diagram. And the parsed nodes.
I want you to add any labels that apply to each node.
Do not parse any additional text.
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = ArgumentParser(description="Parse labels from extracted images.")
    parser.add_argument(
        "--model",
        default=MODEL,
