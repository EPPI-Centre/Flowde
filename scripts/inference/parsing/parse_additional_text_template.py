...
DIR_NAME_TO_SAVE_RESULTS = "template_parse_just_additional_text_results"
...
INPUT_TEXT = """
I am sending you an image of a particpant flow diagram, the nodes and the
labels. I want you to parse the additional text.
...
def main(argv: Sequence[str] | None = None) -> None:
    parser = ArgumentParser(description="Parse additional text from extracted images.")
    parser.add_argument(
        "--model",
        default=MODEL,
