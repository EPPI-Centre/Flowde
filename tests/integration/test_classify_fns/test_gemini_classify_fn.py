...
import flowde.classify_fns.gemini_classify_fn as gemini_classify_fn_module
...
def test_gemini_classify_fn_classifies_simple_flowchart_image(tmp_path):
    get_required_env_var("GOOGLE_API_KEY")

    img_path = tmp_path / "simple_flowchart.png"
    create_simple_flowchart_image(img_path)

    classify_fn = gemini_classify_fn_module.make_gemini_classify_fn(
        input_text=(
...
def test_gemini_classify_fn_classifies_non_flowchart_image(tmp_path):
    get_required_env_var("GOOGLE_API_KEY")
...
def test_gemini_classify_fn_accepts_different_structure(tmp_path):
    get_required_env_var("GOOGLE_API_KEY")
